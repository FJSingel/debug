...
public class EnglishNumber {
     ...
     */
    private ArrayList<NumberToken> tokens = null;
     ...
     */
    private static ArrayList<NumberToken> toTokens(ArrayList<String> in){
        assert (in != null);
        
        ArrayList<NumberToken> toReturn = new ArrayList<NumberToken>(in.size()-1);
